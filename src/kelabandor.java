...
public class kelabandor {
	...
	private JFrame frmKelaBandorCalculator;
	double first;
	double second;
	double result;
	String operation;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmKelaBandorCalculator.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmKelaBandorCalculator = new JFrame();
		frmKelaBandorCalculator.setTitle("Kela Bandor Calculator");
		frmKelaBandorCalculator.setIconImage(Toolkit.getDefaultToolkit().getImage("G:\\LoGOs\\Name Logo Mini.png"));
		frmKelaBandorCalculator.getContentPane().setForeground(Color.GREEN);
		frmKelaBandorCalculator.getContentPane().setFont(new Font("Tahoma", Font.BOLD, 11));
		frmKelaBandorCalculator.getContentPane().setBackground(Color.BLACK);
		frmKelaBandorCalculator.setBounds(100, 100, 494, 360);
		frmKelaBandorCalculator.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmKelaBandorCalculator.getContentPane().setLayout(null);
		...
		frmKelaBandorCalculator.getContentPane().add(textArea);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_1);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_2);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_3);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_4);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_6);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_7);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_8);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_9);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_10);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_11);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_10_1);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_11_1);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_1);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_2);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_3);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_4);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_5);
		...
		frmKelaBandorCalculator.getContentPane().add(btnNewButton_5_6);
	}
}
